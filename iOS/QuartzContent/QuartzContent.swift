...
public final class ContentByAuthorQuery: GraphQLQuery {
  /// The raw GraphQL definition of this operation.
  public let operationDefinition: String =
    """
  ...
  public let operationIdentifier: String? = "8524285f3f5c0eb82992ff434018e8b57ab121ab935b08118dc0ee22ccdf3d13"
  ...
  public init(slug: String, perPage: Int, after: String? = nil) {
    self.slug = slug
    self.perPage = perPage
    self.after = after
  }
  ...
  public var variables: GraphQLMap? {
    return ["slug": slug, "perPage": perPage, "after": after]
  }
  ...
  public struct Data: GraphQLSelectionSet {
    ...
    public static var selections: [GraphQLSelection] {
      return [
        GraphQLField("coAuthors", alias: "authors", arguments: ["where": ["name": [GraphQLVariable("slug")]]], type: .object(Author.selections)),
        GraphQLField("authorContent", arguments: ["after": GraphQLVariable("after"), "first": GraphQLVariable("perPage"), "where": ["slug": GraphQLVariable("slug")]], type: .object(AuthorContent.selections)),
      ]
    }
    ...
    public init(authors: Author? = nil, authorContent: AuthorContent? = nil) {
      self.init(unsafeResultMap: ["__typename": "RootQuery", "authors": authors.flatMap { (value: Author) -> ResultMap in value.resultMap }, "authorContent": authorContent.flatMap { (value: AuthorContent) -> ResultMap in value.resultMap }])
    }
    ...
    public var authorContent: AuthorContent? {
      get {
        return (resultMap["authorContent"] as? ResultMap).flatMap { AuthorContent(unsafeResultMap: $0) }
      }
      set {
        resultMap.updateValue(newValue?.resultMap, forKey: "authorContent")
      }
    }
    ...
    public struct AuthorContent: GraphQLSelectionSet {
      ...
      public struct Node: GraphQLSelectionSet {
        ...
        public static var selections: [GraphQLSelection] {
          return [
            GraphQLTypeCase(
              variants: ["Email": AsEmail.selections, "Post": AsPost.selections],
              default: [
                GraphQLField("__typename", type: .nonNull(.scalar(String.self))),
              ]
            )
...
public final class ContentBySearchTermQuery: GraphQLQuery {
  ...
  public struct Data: GraphQLSelectionSet {
    ...
    public struct Content: GraphQLSelectionSet {
      public static let possibleTypes: [String] = ["RootQueryToContentConnection"]
      ...
      public init(pageInfo: PageInfo? = nil, nodes: [Node?]? = nil) {
        self.init(unsafeResultMap: ["__typename": "RootQueryToContentConnection", "pageInfo": pageInfo.flatMap { (value: PageInfo) -> ResultMap in value.resultMap }, "nodes": nodes.flatMap { (value: [Node?]) -> [ResultMap?] in value.map { (value: Node?) -> ResultMap? in value.flatMap { (value: Node) -> ResultMap in value.resultMap } } }])
      }
...
public final class ContentByTagQuery: GraphQLQuery {
  /// The raw GraphQL definition of this operation.
  public let operationDefinition: String =
    """
  ...
  public let operationIdentifier: String? = "f084126ffa8de4582bed471b9a1fd55a52ae7d0f1714dac50f7df63ce87c9e0c"
  ...
  public init(slug: String, perPage: Int? = nil, after: String? = nil) {
    self.slug = slug
    self.perPage = perPage
    self.after = after
  }
  ...
  public struct Data: GraphQLSelectionSet {
    ...
    public static var selections: [GraphQLSelection] {
      return [
        GraphQLField("tags", arguments: ["where": ["slug": [GraphQLVariable("slug")]]], type: .object(Tag.selections)),
        GraphQLField("tagContent", arguments: ["after": GraphQLVariable("after"), "first": GraphQLVariable("perPage"), "where": ["slug": GraphQLVariable("slug")]], type: .object(TagContent.selections)),
      ]
    }
    ...
    public init(tags: Tag? = nil, tagContent: TagContent? = nil) {
      self.init(unsafeResultMap: ["__typename": "RootQuery", "tags": tags.flatMap { (value: Tag) -> ResultMap in value.resultMap }, "tagContent": tagContent.flatMap { (value: TagContent) -> ResultMap in value.resultMap }])
    }
    ...
    /// Connection between the RootQuery type and the ContentUnion type
    public var tagContent: TagContent? {
      get {
        return (resultMap["tagContent"] as? ResultMap).flatMap { TagContent(unsafeResultMap: $0) }
      }
      set {
        resultMap.updateValue(newValue?.resultMap, forKey: "tagContent")
      }
    }
    ...
    public struct TagContent: GraphQLSelectionSet {
      public static let possibleTypes: [String] = ["RootQueryToTagContentConnection"]
      ...
      public init(nodes: [Node?]? = nil, pageInfo: PageInfo? = nil) {
        self.init(unsafeResultMap: ["__typename": "RootQueryToTagContentConnection", "nodes": nodes.flatMap { (value: [Node?]) -> [ResultMap?] in value.map { (value: Node?) -> ResultMap? in value.flatMap { (value: Node) -> ResultMap in value.resultMap } } }, "pageInfo": pageInfo.flatMap { (value: PageInfo) -> ResultMap in value.resultMap }])
      }
...
public final class FirstFeedConcentByRecencyQuery: GraphQLQuery {
  ...
  public let operationIdentifier: String? = "b8687734f92e280109e2fdca7e6f58e4d9f71872485ced281353b5590ba6eb74"
  ...
  public struct Data: GraphQLSelectionSet {
    ...
    public static var selections: [GraphQLSelection] {
      return [
        GraphQLField("feedContent", arguments: ["first": GraphQLVariable("first")], type: .object(FeedContent.selections)),
      ]
    }
...
public final class FirstPopularArticlesQuery: GraphQLQuery {
  /// The raw GraphQL definition of this operation.
  public let operationDefinition: String =
    """
  ...
  public init(edition: EditionName? = nil, first: Int? = nil) {
    self.edition = edition
    self.first = first
  }

  public var variables: GraphQLMap? {
    return ["edition": edition, "first": first]
  }
...
public final class LatestFeedContentQuery: GraphQLQuery {
  ...
  public let operationIdentifier: String? = "26d7f4aeb766025f8a9f430d45c93e944a40539416818afc890ef6621d21584d"
...
public final class EssentialsByArticlePreviewQuery: GraphQLQuery {
  /// The raw GraphQL definition of this operation.
  public let operationDefinition: String =
    """
  ...
  public let operationName: String = "EssentialsByArticlePreview"

  public let operationIdentifier: String? = "83cd2bc6e66a7f4b3a8970e9cd5864f0bd46f632aa9e90d7e97b68ca2aa61fe3"
...
public final class EssentialsByCollectionQuery: GraphQLQuery {
  /// The raw GraphQL definition of this operation.
  public let operationDefinition: String =
    """
  ...
  public let operationIdentifier: String? = "bb484107080c059d05bcb99cf6bca4c798fcc74fddcd1439525e1a48a2be4817"
...
public final class EssentialsByGuideQuery: GraphQLQuery {
  ...
  public let operationIdentifier: String? = "df1494d49b9b1a17a267d2d07449219b61db3c5133e6e396146f9d4e5b9abcd7"
...
public final class EssentialsByObsessionQuery: GraphQLQuery {
  ...
  public let operationIdentifier: String? = "7568a7f5cec928baca0ca7ff8ba2d4cc8d85dbd2c67a89d60f2e5dc436e72503"
...
public final class NonHomeEssentialsQuery: GraphQLQuery {
  /// The raw GraphQL definition of this operation.
  public let operationDefinition: String =
    """
  ...
  public let operationName: String = "NonHomeEssentials"

  public let operationIdentifier: String? = "b52290432468fd30618a35817a1eb75d8d4cc91ec3f0554073020e1b2b0c3dec"
  ...
  public struct Data: GraphQLSelectionSet {
    ...
    public static var selections: [GraphQLSelection] {
      return [
        GraphQLField("collections", arguments: ["first": GraphQLVariable("perPage"), "after": GraphQLVariable("after"), "where": ["tagNotIn": 400]], type: .object(Collection.selections)),
      ]
    }
    ...
    public struct Collection: GraphQLSelectionSet {
      ...
      public init(nodes: [Node?]? = nil, pageInfo: PageInfo? = nil) {
        self.init(unsafeResultMap: ["__typename": "RootQueryToCollectionConnection", "nodes": nodes.flatMap { (value: [Node?]) -> [ResultMap?] in value.map { (value: Node?) -> ResultMap? in value.flatMap { (value: Node) -> ResultMap in value.resultMap } } }, "pageInfo": pageInfo.flatMap { (value: PageInfo) -> ResultMap in value.resultMap }])
      }
...
public final class EmailByIdQuery: GraphQLQuery {
  ...
  public let operationIdentifier: String? = "7e2e1a02937ed1ff472e28012ebc59c552c156130e96bcd6c468a127a8f54360"
...
public final class EmailsByAuthorQuery: GraphQLQuery {
  /// The raw GraphQL definition of this operation.
  public let operationDefinition: String =
    """
  ...
  public let operationIdentifier: String? = "b056ba585dbf119d46193e19d9e46e623e621abe0a382d8d64900b5d2b83fbd7"
      ...
      public struct Node: GraphQLSelectionSet {
        ...
        public static var selections: [GraphQLSelection] {
          return [
            GraphQLField("__typename", type: .nonNull(.scalar(String.self))),
            GraphQLFragmentSpread(AuthorParts.self),
            GraphQLField("emails", arguments: ["after": GraphQLVariable("after"), "first": GraphQLVariable("perPage")], type: .object(Email.selections)),
          ]
        }
        ...
        /// Connection between the coAuthor type and the email type
        public var emails: Email? {
          get {
            return (resultMap["emails"] as? ResultMap).flatMap { Email(unsafeResultMap: $0) }
          }
        ...
        public struct Email: GraphQLSelectionSet {
          public static let possibleTypes: [String] = ["CoAuthorToEmailConnection"]
          ...
          public init(nodes: [Node?]? = nil, pageInfo: PageInfo? = nil) {
            self.init(unsafeResultMap: ["__typename": "CoAuthorToEmailConnection", "nodes": nodes.flatMap { (value: [Node?]) -> [ResultMap?] in value.map { (value: Node?) -> ResultMap? in value.flatMap { (value: Node) -> ResultMap in value.resultMap } } }, "pageInfo": pageInfo.flatMap { (value: PageInfo) -> ResultMap in value.resultMap }])
          }
...
public final class EmailsByListQuery: GraphQLQuery {
  ...
  public let operationIdentifier: String? = "3f79959e8bf35538cba5f07e6546f38a60d390d2be4df5b547460a8a68c2f37e"
...
public final class EmailsByTagQuery: GraphQLQuery {
  ...
  public let operationIdentifier: String? = "9d238c5e36637bc7ae1a12a39cd9e1404104782e59522330a57b71184cb4e3fa"
...
public final class LatestEmailByListQuery: GraphQLQuery {
  /// The raw GraphQL definition of this operation.
  public let operationDefinition: String =
    """
  ...
  public let operationIdentifier: String? = "379ff45eec7c68f5fa3ad458a0033f8ba419d34a469f434780d56f62502a0702"
...
public final class HomeCollectionQuery: GraphQLQuery {
  ...
  public let operationIdentifier: String? = "62937df7189382b272a88a7d971812c8474f667e180185d70f8a780b2a3f1804"
...
public final class HomeCollectionPreviewQuery: GraphQLQuery {
  ...
  public let operationIdentifier: String? = "a1840b13c7bb92d7e588207ee761a3b7adc42c20e0c851ec2bbeb1f9dab09cea"
...
public struct BulletinDataParts: GraphQLFragment {
  /// The raw GraphQL definition of this fragment.
  public static let fragmentDefinition: String =
    """
  ...
  public init(campaign: Campaign? = nil, clientTracking: ClientTracking? = nil, sponsor: Sponsor? = nil) {
    self.init(unsafeResultMap: ["__typename": "BulletinData", "campaign": campaign.flatMap { (value: Campaign) -> ResultMap in value.resultMap }, "clientTracking": clientTracking.flatMap { (value: ClientTracking) -> ResultMap in value.resultMap }, "sponsor": sponsor.flatMap { (value: Sponsor) -> ResultMap in value.resultMap }])
  }
  ...
  public struct Campaign: GraphQLSelectionSet {
    ...
    public init(attribution: String? = nil, id: String? = nil, logo: String? = nil, logoLink: String? = nil, name: String? = nil, slug: String? = nil) {
      self.init(unsafeResultMap: ["__typename": "CampaignData", "attribution": attribution, "id": id, "logo": logo, "logoLink": logoLink, "name": name, "slug": slug])
    }
...
public struct CollectionParts: GraphQLFragment {
  ...
  public static var selections: [GraphQLSelection] {
    return [
      ...
      GraphQLField("modifiedGmt", type: .scalar(String.self)),
      GraphQLField("slug", type: .scalar(String.self)),
      GraphQLField("tags", arguments: ["where": ["orderby": "COUNT"], "last": 10], type: .object(Tag.selections)),
      GraphQLField("featuredImage", type: .object(FeaturedImage.selections)),
      GraphQLField("blocks", type: .list(.object(Block.selections))),
    ]
  }
  ...
  public init(id: GraphQLID, collectionId: Int, title: String? = nil, dateGmt: String? = nil, excerpt: String? = nil, modifiedGmt: String? = nil, slug: String? = nil, tags: Tag? = nil, featuredImage: FeaturedImage? = nil, blocks: [Block?]? = nil) {
  ...
  public struct Tag: GraphQLSelectionSet {
    public static let possibleTypes: [String] = ["CollectionToTagConnection"]
    ...
    public init(nodes: [Node?]? = nil) {
      self.init(unsafeResultMap: ["__typename": "CollectionToTagConnection", "nodes": nodes.flatMap { (value: [Node?]) -> [ResultMap?] in value.map { (value: Node?) -> ResultMap? in value.flatMap { (value: Node) -> ResultMap in value.resultMap } } }])
    }
    ...
    public struct Node: GraphQLSelectionSet {
      ...
      public init(slug: String? = nil) {
        self.init(unsafeResultMap: ["__typename": "Tag", "slug": slug])
      }
...
public struct EmailTeaserParts: GraphQLFragment {
  ...
  public init(id: GraphQLID, dateGmt: String? = nil, emailId: Int, featuredImage: FeaturedImage? = nil, link: String? = nil, slug: String? = nil, segment: String? = nil, socialImage: SocialImage? = nil, seoTitle: String? = nil, socialDescription: String? = nil, socialTitle: String? = nil, subject: String? = nil, title: String? = nil, tags: Tag? = nil, authors: Author? = nil) {
    self.init(unsafeResultMap: ["__typename": "Email", "id": id, "dateGmt": dateGmt, "emailId": emailId, "featuredImage": featuredImage.flatMap { (value: FeaturedImage) -> ResultMap in value.resultMap }, "link": link, "slug": slug, "segment": segment, "socialImage": socialImage.flatMap { (value: SocialImage) -> ResultMap in value.resultMap }, "seoTitle": seoTitle, "socialDescription": socialDescription, "socialTitle": socialTitle, "subject": subject, "title": title, "tags": tags.flatMap { (value: Tag) -> ResultMap in value.resultMap }, "authors": authors.flatMap { (value: Author) -> ResultMap in value.resultMap }])
  }
  ...
  /// Connection between the email type and the tag type
  public var tags: Tag? {
    get {
      return (resultMap["tags"] as? ResultMap).flatMap { Tag(unsafeResultMap: $0) }
    }
  ...
  public struct Tag: GraphQLSelectionSet {
    public static let possibleTypes: [String] = ["EmailToTagConnection"]
    ...
    public init(nodes: [Node?]? = nil) {
      self.init(unsafeResultMap: ["__typename": "EmailToTagConnection", "nodes": nodes.flatMap { (value: [Node?]) -> [ResultMap?] in value.map { (value: Node?) -> ResultMap? in value.flatMap { (value: Node) -> ResultMap in value.resultMap } } }])
    }
    ...
    public struct Node: GraphQLSelectionSet {
      ...
      public init(id: GraphQLID, slug: String? = nil, name: String? = nil) {
        self.init(unsafeResultMap: ["__typename": "Tag", "id": id, "slug": slug, "name": name])
      }
...
public struct MenuItemParts: GraphQLFragment {
  ...
  public struct ConnectedNode: GraphQLSelectionSet {
    ...
    public struct Node: GraphQLSelectionSet {
      public static let possibleTypes: [String] = ["Post", "Page", "CoAuthor", "Chapter", "Tag", "BlogPost", "Collection", "Email", "EmailList", "Nug", "Topic", "EmailSegment", "Promotion", "Obsession", "Show", "Category"]
