...
exports.useCollectionByIdLazyQuery = exports.useCollectionByIdQuery = exports.CollectionByIdDocument = void 0;
const client_1 = require("@apollo/client");
const CollectionParts_1 = require("./CollectionParts");
const Apollo = __importStar(require("@apollo/client"));
const defaultOptions = {};
exports.CollectionByIdDocument = client_1.gql `
 ...
 * });
 */
function useCollectionByIdQuery(baseOptions) {
    const options = Object.assign(Object.assign({}, defaultOptions), baseOptions);
    return Apollo.useQuery(exports.CollectionByIdDocument, options);
}
exports.useCollectionByIdQuery = useCollectionByIdQuery;
function useCollectionByIdLazyQuery(baseOptions) {
    const options = Object.assign(Object.assign({}, defaultOptions), baseOptions);
    return Apollo.useLazyQuery(exports.CollectionByIdDocument, options);
}
exports.useCollectionByIdLazyQuery = useCollectionByIdLazyQuery;
